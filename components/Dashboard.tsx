...
export const Dashboard: React.FC<DashboardProps> = ({ officials, sentHistory, onNavigate, onImport, onExportExcel, onNewOfficial, onClearDatabase }) => {
                ...
                {expiringCount > 0 && (
                    <div onClick={() => onNavigate('database', { type: 'expiringSoon' })} className="flex items-center justify-between p-4 bg-amber-50 border border-amber-100 rounded-xl cursor-pointer hover:bg-amber-100 transition-colors">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-sm font-bold text-amber-900">{expiringCount} contratos vencen este mes</span>
                        </div>

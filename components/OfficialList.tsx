            ...
            return (
              <div key={official.id} className={`bg-white rounded-2xl shadow-sm border p-6 hover:shadow-md transition-all relative overflow-hidden group ${isExpiringSoon ? 'border-amber-300 bg-amber-50/20' : 'border-slate-200'}`}>
                ...
                <div className="absolute bottom-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  <button onClick={() => onDelete(official.id)} className="p-2 bg-rose-50 text-rose-600 rounded-lg hover:bg-rose-100 transition-colors"><Trash2 className="w-4 h-4" /></button>
                </div>
              </div>
            );
          })}
                                ...
                                <tr key={official.id} className={`hover:bg-slate-50 transition-colors ${isExpiringSoon ? 'bg-amber-50/20' : ''}`}>
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <div className="flex justify-end gap-1">
                                            ...
                                            <button onClick={() => onDelete(official.id)} className="p-1.5 text-slate-400 hover:text-rose-600 transition-colors rounded-md hover:bg-rose-50">

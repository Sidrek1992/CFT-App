...
| `GOOGLE_REDIRECT_URI` | `https://myappcftcorreo.vercel.app/api/auth/google/callback` | Redirect URI para OAuth |
| `APP_BASE_URL` | `https://myappcftcorreo.vercel.app` | URL base de la aplicación |
